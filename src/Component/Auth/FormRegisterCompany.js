...
const CompanyComp = () => {
  return (
    <div className='bg-[#E5E5E5] w-3/5 px-32 py-10 h-screen'>
      ...
      <form className='no-scrollbar overflow-y-scroll h-4/6'>
        ...
        <div className='flex flex-col mb-5'>
          ...
          <input text="input" placeholder="Masukkan nama perusahaan" className="outline-none px-3 py-2 placeholder-gray-500 text-black rounded-[3px] " />
        </div>
        <div className='flex flex-col mb-5'>
          <span>Bidang Perusahaan</span>
          <input text="input" placeholder="Masukkan bidang perusahaan Anda" className="outline-none px-3 py-2 placeholder-gray-500 text-black rounded-[3px] " />
        </div>
        <div className='flex flex-col mb-5'>
          <span>No Handphone</span>
          <input text="input" placeholder="Masukkan no handphone" className="outline-none px-3 py-2 placeholder-gray-500 text-black rounded-[3px] " />
        </div>
        <div className='flex flex-col mb-5'>

  ...
  return(
    ...
    <div className="bg-slate-100 pb-16">
      <div className="bg-violet-700 h-80 w-full"></div>
        <div className="my-5 flex w-4/6 mx-auto -mt-64">
          <div className="bg-white rounded-xl p-6 w-7/12 border-2 mr-10 justify-around">
            <div>
        ...
        <div className="flex flex-col bg-white rounded-xl p-5 w-full h-[80vh]">
          <div className="p-1">
